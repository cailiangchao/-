...
const IMAGE_MAX_X = 980; // 根据图片X轴最右侧大致估算
...
const room607Config = {
    ...
    beds: [
        ...
        { id: "607-02", position: { x: mapX(218), y: mapY(-0) }, rotation: 0, hasOxygen: false },
        { id: "607-03", position: { x: mapX(286), y: mapY(-0) }, rotation: 0, hasOxygen: false },
        { id: "607-05", position: { x: mapX(354), y: mapY(-0) }, rotation: 0, hasOxygen: false },
        { id: "607-06", position: { x: mapX(422), y: mapY(-0) }, rotation: 0, hasOxygen: false },
        { id: "607-07", position: { x: mapX(490), y: mapY(-0) }, rotation: 0, hasOxygen: false },
        { id: "607-08", position: { x: mapX(558), y: mapY(-0) }, rotation: 0, hasOxygen: false },
        { id: "607-09", position: { x: mapX(626), y: mapY(-0) }, rotation: 0, hasOxygen: false },
        { id: "607-10", position: { x: mapX(694), y: mapY(-0) }, rotation: 0, hasOxygen: false },
        { id: "607-11", position: { x: mapX(762), y: mapY(-0) }, rotation: 0, hasOxygen: false },
        { id: "607-12", position: { x: mapX(860), y: mapY(-0) }, rotation: 0, hasOxygen: false, type: 'infection-bed' }, // 12,13是黄色床位
        { id: "607-13", position: { x: mapX(920), y: mapY(-0) }, rotation: 0, hasOxygen: false, type: 'infection-bed' },

        // 第二排床位 (Y约-170)
        { id: "607-15", position: { x: mapX(150), y: mapY(-220) }, rotation: 0, hasOxygen: false },
        { id: "607-16", position: { x: mapX(227), y: mapY(-220) }, rotation: 0, hasOxygen: false },
        { id: "607-17", position: { x: mapX(304), y: mapY(-220) }, rotation: 0, hasOxygen: false },
        { id: "607-18", position: { x: mapX(381), y: mapY(-220) }, rotation: 0, hasOxygen: false },
        { id: "607-19", position: { x: mapX(500), y: mapY(-220) }, rotation: 0, hasOxygen: false },
        { id: "607-20", position: { x: mapX(560), y: mapY(-220) }, rotation: 0, hasOxygen: false },
        { id: "607-21", position: { x: mapX(620), y: mapY(-220) }, rotation: 0, hasOxygen: false },
        { id: "607-22", position: { x: mapX(680), y: mapY(-220) }, rotation: 0, hasOxygen: false },
        { id: "607-23", position: { x: mapX(760), y: mapY(-220) }, rotation: 0, hasOxygen: false },
        { id: "607-25", position: { x: mapX(860), y: mapY(-220) }, rotation: 0, hasOxygen: false, type: 'infection-bed' }, // 25,26是黄色床位
        { id: "607-26", position: { x: mapX(930), y: mapY(-220) }, rotation: 0, hasOxygen: false, type: 'infection-bed' },

        // 第三排床位 (Y约-320)
        { id: "607-45", position: { x: mapX(150), y: mapY(-320) }, rotation: 0, hasOxygen: false },
        { id: "607-27", position: { x: mapX(350), y: mapY(-320) }, rotation: 0, hasOxygen: true }, // 607-27有氧源
        { id: "607-28", position: { x: mapX(410), y: mapY(-320) }, rotation: 0, hasOxygen: false },
        { id: "607-29", position: { x: mapX(500), y: mapY(-320) }, rotation: 0, hasOxygen: true }, // 607-29有氧源
        { id: "607-30", position: { x: mapX(560), y: mapY(-320) }, rotation: 0, hasOxygen: false },
        ...
        { id: "607-32", position: { x: mapX(510), y: mapY(-470) }, rotation: 0, hasOxygen: true }, // 607-32有氧源
        { id: "607-31", position: { x: mapX(570), y: mapY(-470) }, rotation: 0, hasOxygen: false },
    ...
    facilities: [
        ...
        { type: "cabinet", label: "柜子", position: { x: mapX(100), y: mapY(0) }, width: mapX(40), height: mapY(20)-mapY(180) },
        { type: "bed-side-xray-machine", label: "疫苗接种区", position: { x: mapX(0), y: mapY(-180) }, width: mapX(90), height: mapY(200) },
        { type: "small-bed-collection-area", label: "小床集中放置处", position: { x: mapX(0), y: mapY(-380) }, width: mapX(60), height: mapY(300) },
        
        // 设备带 (Equipment Belts)
        
        { type: "equipment-belt", label: "设备带", position: { x: mapX(130), y: mapY(-300) }, width: mapX(320), height: mapY(20) },
        { type: "equipment-belt", label: "设备带", position: { x: mapX(500), y: mapY(-300) }, width: mapX(295), height: mapY(20) },
        { type: "equipment-belt", label: "设备带", position: { x: mapX(850), y: mapY(-300) }, width: mapX(130), height: mapY(20) },

        // 中间墙体和电脑
        { type: "wall ", label: "墙体", position: { x: mapX(250), y: mapY(-380) }, width: mapX(100), height: mapY(20)-mapY(170) },
        { type: "computer", label: "电脑", position: { x: mapX(610), y: mapY(-320) }, width: mapX(50), height: mapY(20) },
        { type: "wall ", label: "墙体", position: { x: mapX(620), y: mapY(-380) }, width: mapX(60), height: mapY(180) },
        { type: "cabinet", label: "柜子", position: { x: mapX(370), y: mapY(-520) }, width: mapX(110), height: mapY(30) },
        ...
        { type: "area-label", label: "A 区", position: { x: mapX(400), y: mapY(-420) }, width: mapX(60), height: mapY(30) },
        { type: "area-label", label: "C 区", position: { x: mapX(800), y: mapY(-370) }, width: mapX(60), height: mapY(30) },
        { type: "infection-zone", label: "感染病区 (12张床)", position: { x: mapX(750), y: mapY(-420) }, width: mapX(200), height: mapY(50) }
    ],
    // 氧源接口位置 (●)
    oxygenSources: [],
    // 机械吊塔位置
...
function renderRoom607() {
    ...
    room607Config.facilities.forEach(facility => {
        ...
        // Only set height for non-wall elements
        if (facility.height && !facility.type.includes('wall')) { 
